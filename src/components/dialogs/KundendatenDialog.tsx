...
export function KundendatenDialog({ open, onClose, onSubmit, defaultValues, leistungskatalogList, enablePhotoScan = false, enablePhotoLocation = true }: KundendatenDialogProps) {
