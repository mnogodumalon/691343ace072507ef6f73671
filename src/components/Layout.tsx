...
import { IconArrowBackUp, IconCalendarEvent, IconFileText, IconLayoutDashboard, IconMenu2, IconSettings, IconUsers, IconPlayerPlay, IconChevronDown } from '@tabler/icons-react';
import { useState, useEffect } from 'react';
import ChatWidget from '@/components/ChatWidget';
import { TopBar } from '@/components/TopBar';
import { useActions } from '@/context/ActionsContext';

const APP_TITLE = 'Massage-Buchungssystem';
...
const navigation = [
  ...
  { name: 'Leistungskatalog 2', href: '/leistungskatalog-2', icon: IconFileText },
  { name: 'Leistungskatalog', href: '/leistungskatalog', icon: IconFileText },
  { name: 'Impressum', href: '/impressum', icon: IconFileText },
  { name: 'Terminanfrage', href: '/terminanfrage', icon: IconCalendarEvent },
  { name: 'Kundendaten', href: '/kundendaten', icon: IconUsers },
];

const externalNavigation = [
  { name: 'Leistungskatalog 2', href: '/gateway/apps/692a00a775bdd48e383a981e?template=list_page', icon: IconFileText },
  { name: 'Leistungskatalog', href: '/gateway/apps/6913437daff7287a0f9bab21?template=list_page', icon: IconFileText },
  { name: 'Impressum', href: '/gateway/apps/692ef3bf7b163c49a87dc883?template=list_page', icon: IconFileText },
  { name: 'Terminanfrage', href: '/gateway/apps/691343895f81839bc1f243fe?template=list_page', icon: IconCalendarEvent },
  { name: 'Kundendaten', href: '/gateway/apps/69134384a7881852231ba8c7?template=list_page', icon: IconUsers },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/692a00a775bdd48e383a981e?template=list_page"
