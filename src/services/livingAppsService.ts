...
import type { Leistungskatalog, Leistungskatalog2, Impressum, Kundendaten, CreateLeistungskatalog, CreateLeistungskatalog2, CreateImpressum, CreateKundendaten } from '@/types/app';
...
export class LivingAppsService {
  ...
  static async createLeistungskatalogEntry(fields: CreateLeistungskatalog) {
    return callApi('POST', `/apps/${APP_IDS.LEISTUNGSKATALOG}/records`, { fields: cleanFieldsForApi(fields as any, 'leistungskatalog') });
  }
  static async updateLeistungskatalogEntry(id: string, fields: Partial<CreateLeistungskatalog>) {
    return callApi('PATCH', `/apps/${APP_IDS.LEISTUNGSKATALOG}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'leistungskatalog') });
  }
  ...
  static async createLeistungskatalog2Entry(fields: CreateLeistungskatalog2) {
    return callApi('POST', `/apps/${APP_IDS.LEISTUNGSKATALOG_2}/records`, { fields: cleanFieldsForApi(fields as any, 'leistungskatalog_2') });
  }
  static async updateLeistungskatalog2Entry(id: string, fields: Partial<CreateLeistungskatalog2>) {
    return callApi('PATCH', `/apps/${APP_IDS.LEISTUNGSKATALOG_2}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'leistungskatalog_2') });
  }
  ...
  static async createImpressumEntry(fields: CreateImpressum) {
    return callApi('POST', `/apps/${APP_IDS.IMPRESSUM}/records`, { fields: cleanFieldsForApi(fields as any, 'impressum') });
  }
  static async updateImpressumEntry(id: string, fields: Partial<CreateImpressum>) {
    return callApi('PATCH', `/apps/${APP_IDS.IMPRESSUM}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'impressum') });
  }
  ...
  static async createKundendatenEntry(fields: CreateKundendaten) {
    return callApi('POST', `/apps/${APP_IDS.KUNDENDATEN}/records`, { fields: cleanFieldsForApi(fields as any, 'kundendaten') });
  }
  static async updateKundendatenEntry(id: string, fields: Partial<CreateKundendaten>) {
    return callApi('PATCH', `/apps/${APP_IDS.KUNDENDATEN}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'kundendaten') });
  }
